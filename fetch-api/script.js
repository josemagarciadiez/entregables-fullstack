...
function createBackCard(pokemon) {
  ...
  $stats_container.classList.add("stats");
  ...
  $stats_container.appendChild($header);
  $stats_container.appendChild($badges);

  $card.appendChild($image_container);
  $card.appendChild($stats_container);
